        ...
        <div className="container-fluid px-4">
            <div className="card mt-4">
                <div className="card-header">
                    <h4>Sửa thú cưng
                        <Link to="/admin/view-product" className="btn btn-primary btn-sm float-end">Xem thú cưng</Link>
                    </h4>
                </div>
                            ...
                            <div className="tab-pane card-body border fade" id="otherdetails" role="tabpanel" aria-labelledby="otherdetails-tab">
                                <div className="row">
                                    ...
                                    <div className="col-md-8 form-group mb-3">
                                        ...
                                        <img src={`${config.BASE_URL}/${productInput.image}`} width="50px" alt={productInput.name} />
