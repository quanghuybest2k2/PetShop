                    ...
                    <tbody>
                        {cart.map((item, idx) => {
                            ...
                            return (
                                <tr key={idx}>
                                    <td width="10%">
                                        <img src={`${config.BASE_URL}/${item.product.image}`} alt={item.product.name} width="50px" height="50px" />
                                    </td>
                                    ...
                                    <td width="15%" className="text-center">
                                        {numeral(item.product.selling_price * item.product_qty).format('0,0')}đ
                                    </td>
                                    <td width="10%">
                ...
                <div className="col-md-4">
                    <div className="card card-body mt-3">
                        <h4>Tổng cộng:
                            ...
                            <span className="float-end">{numeral(totalCartPrice).format('0,0')}đ</span>
                        </h4>
                        <h4>Tổng tiền:
                            <span className="float-end">{numeral(totalCartPrice).format('0,0')}đ</span>
                        </h4>
